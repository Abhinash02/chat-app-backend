...
export const GAMES = Object.freeze([
  ...
  },
  {
    key: 'color-match',
    name: 'Color Match',
    description: 'The word names a colour. Tap the swatch that matches the word, not the ink.',
    emoji: '\u{1F3A8}',
    maxScore: 400,
    minDurationMs: 8_000,
    maxDurationMs: 5 * 60_000,
  ...
  },
  {
    ...
    description: 'Watch the pattern, then repeat it. It grows by one every round.',
    emoji: '\u{1F9E9}',
    maxScore: 400,
    minDurationMs: 8_000,
    maxDurationMs: 10 * 60_000,
    // Reaching a long sequence is rare and deserves more than a tap-counter.
    pointsPerScore: 2,
    maxPointsPerSession: 400,
  },
  {
    key: 'odd-one-out',
    name: 'Odd One Out',
    description: 'One tile in the grid is different. Find it before the clock does.',
    emoji: '\u{1F50D}',
    maxScore: 400,
    minDurationMs: 8_000,
    maxDurationMs: 5 * 60_000,
  ...
  },
  {
    key: 'bubble-pop',
    name: 'Bubble Pop',
    description: 'Pop the bubbles, leave the bombs alone.',
    emoji: '\u{1FAE7}',
    maxScore: 500,
    minDurationMs: 8_000,
    maxDurationMs: 5 * 60_000,
  ...
  },
  {
    key: 'rapid-recall',
    name: 'Rapid Recall',
    description: 'A few digits flash up. Type them straight back.',
    emoji: '\u{1F522}',
    maxScore: 400,
    minDurationMs: 8_000,
    maxDurationMs: 10 * 60_000,
